 ...
 */
import { type BodyType, createInstance } from './index'
...
export type UsersControllerCreate201 = { [key: string]: any }

export type UsersControllerFindAll200 = { [key: string]: any }
...
export const usersControllerFindAll = (options?: SecondParameter<typeof createInstance>) => {
  return createInstance<UsersControllerFindAll200>({ method: 'GET', url: `/v1/users` }, options)
}
...
export const usersControllerCreate = (
  ...
  return createInstance<UsersControllerCreate201>(
    {
...
export const usersControllerRemoveAll = (options?: SecondParameter<typeof createInstance>) => {
  return createInstance<void>({ method: 'DELETE', url: `/v1/users` }, options)
}
...
export const usersControllerRemove = (
  ...
  return createInstance<boolean>({ method: 'DELETE', url: `/v1/users/${id}` }, options)
}
 ...
 */
export const authControllerGetUserData = (options?: SecondParameter<typeof createInstance>) => {
...
>
export type UsersControllerRemoveAllResult = NonNullable<
  Awaited<ReturnType<typeof usersControllerRemoveAll>>
>
